        ...
        <div className="bg-gray-900 pt-24 sm:pt-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-white sm:text-6xl">XHS™ Pricing</p>
            </div>
            ...
            <p className="mx-auto mt-2 max-w-2xl text-center text-base font-medium text-pretty text-gray-400">Annual plans save 8%.</p>
