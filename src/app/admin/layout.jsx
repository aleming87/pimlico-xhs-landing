...
const NAV_ITEMS = [
  ...
  { href: '/admin/drafting',   label: 'Drafts',      icon: '✏️', group: 'pipeline', step: 1 },
  { href: '/admin/collateral', label: 'Collateral',  icon: '🎨', group: 'pipeline', step: 2 },
  { href: '/admin/copy',       label: 'Copy',        icon: '📝', group: 'pipeline', step: 3 },
  { href: '/admin/publishing', label: 'Publishing',  icon: '🚀', group: 'pipeline', step: 4 },
  ...
  { href: '/admin/updates',    label: 'Email Updates', icon: '📧', group: 'comms' },
];
