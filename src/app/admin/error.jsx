  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
      <div className="bg-gray-800/80 rounded-2xl border border-red-500/30 p-8 max-w-lg w-full text-center">
        ...
        <h2 className="text-xl font-medium text-white mb-2">Admin Error</h2>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <a
            href="/admin"
            className="px-6 py-2.5 bg-gray-700 text-gray-300 font-medium rounded-xl hover:bg-gray-600 transition-colors"
          >
            Go to Dashboard
          </a>
        </div>
