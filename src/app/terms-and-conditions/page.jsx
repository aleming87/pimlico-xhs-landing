export const metadata = {
  ...
  openGraph: {
    title: 'Terms and Conditions — Pimlico Solutions',
    description: 'Terms of service for using XHS™ Atlas and the Pimlico Solutions platform.',
  ...
  return (
    <div className="bg-[var(--color-bg-base)] px-6 pt-24 py-32 lg:px-8">
      <div className="mx-auto max-w-4xl text-base leading-7 text-[var(--color-text-tertiary)]">
        ...
        <h1 className="mt-2 text-4xl font-medium tracking-tight text-[var(--color-text-primary)] sm:text-5xl">
        ...
        <div className="mt-10 space-y-8 text-[var(--color-text-tertiary)]">
          ...
          {/* Section 1 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">1. Definitions</h2>
            ...
            <ul className="space-y-3 ml-6">
              ...
              <li><strong>"AI Credits"</strong> means the metered units used by Pimlico to measure usage of AI-powered functionality within the XHS™ Atlas (including, for example, automated monitoring, summarisation, classification, tagging, enrichment and delivery workflows, and associated API or integration calls).</li>
              ...
              <li><strong>"Authorised User"</strong> means an individual who is authorised by Customer to use the XHS™ Atlas under Customer's account, and to whom unique login credentials are supplied by Pimlico.</li>
              <li><strong>"Beta Customer"</strong> means a Customer that is expressly identified as participating in a beta, pilot or early-access programme for the XHS™ Atlas in an Order Form or similar document.</li>
              ...
              <li><strong>"Documentation"</strong> means any user guides, technical documentation, onboarding materials and usage policies for the XHS™ Atlas made available by Pimlico, as updated from time to time.</li>
              <li><strong>"General Release"</strong> means the date on which Pimlico designates a version of the XHS™ Atlas (or relevant module) as generally available for production use outside the applicable beta, pilot or early-access programme.</li>
              ...
              <li><strong>"Materials"</strong> means all reports, dashboards, alerts, newsletters, data outputs, analyses, research, templates, written commentary and other content provided through the XHS™ Atlas or otherwise by Pimlico (excluding Customer Data).</li>
              <li><strong>"Online Order"</strong> means a subscription or purchase for the XHS™ Atlas placed through an online sign-up, in-app purchase flow or similar mechanism made available by Pimlico.</li>
              <li><strong>"Service Period"</strong> or <strong>"Subscription Term"</strong> means the initial term and any renewal term(s) for the XHS™ Atlas, as specified in the applicable Order Form or Online Order.</li>
              ...
              <li><strong>"Security Overview"</strong> means any high-level description of Pimlico's technical and organizational security measures published on the XHS™ website or made available to Customer on request, as updated from time to time.</li>
              <li><strong>"Services"</strong> means the XHS™ Atlas, any related APIs, professional services (including onboarding, configuration or bespoke research) and support services supplied by Pimlico under these Terms.</li>
              ...
              <li><strong>"XHS™ Atlas"</strong> means any conversational, assistant, agentic or similar AI-powered functionality made available by Pimlico as part of the XHS™ Service (including any plans or tiers branded as "XHS™ Atlas"). For the purposes of these Terms, XHS™ Atlas forms part of the XHS™ Service and is not a separate service.</li>
            </ul>
          </section>
          ...
          {/* Section 2 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">2. Scope of services</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">2.1 Nature of the XHS™ Atlas</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">2.2 Access methods</h3>
            <p>
              Customer may access the XHS™ Atlas via web interfaces, APIs, agents, integrations or other methods described in the Documentation.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">2.3 AI features in the XHS™ Service</h3>
            <p>
              Customer acknowledges that the XHS™ Service (including any XHS™ Atlas features) uses artificial intelligence and related techniques to assist with searching, analyzing and presenting information. While Pimlico aims to provide high-quality outputs, the XHS™ Service is intended as a decision-support tool and does not replace Customer's own judgement or the need for independent professional advice.
            </p>
            <p className="mt-3">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">2.4 Support and service levels</h3>
            <p>Unless expressly stated otherwise in an Order Form:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
              <li>Pimlico will provide reasonable remote support during normal business hours for issues relating to the XHS™ Atlas; and</li>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">2.5 Beta programme and General Release</h3>
            <p>Where Customer is a Beta Customer:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
              <li>during the Beta Period, Pimlico will make the relevant XHS™ Atlas functionality available on a beta, pilot or early-access basis and may change, suspend or withdraw such functionality at any time;</li>
              <li>during the Beta Period, there will be no contractual limit on the number of Authorised Users or monitored jurisdictions that may access or use the XHS™ Atlas for Customer's internal business purposes, provided Customer's use remains reasonable and in accordance with these Terms; and</li>
          ...
          {/* Section 3 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">3. Eligibility, authority and customer responsibilities</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.1 Business use only</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.2 Authority and internal approvals</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.3 Customer information and contacts</h3>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.4 Compliance with laws and internal policies</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.5 Responsibility for accounts and Authorised Users</h3>
            <p>Customer is responsible for:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.6 Third-party users</h3>
            <p>
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">4. Orders, formation of Contract and priority</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.1 Orders</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.2 Offer and acceptance</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.3 Priority of documents</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.4 Visitors</h3>
            <p>
          ...
          {/* Section 5 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">5. Access, accounts and security</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.1 Account creation</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.2 Customer responsibilities</h3>
            <p>Customer shall:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.3 Unauthorised access</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.4 Connectivity and equipment</h3>
            <p>
          ...
          {/* Section 6 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">6. License grants and use restrictions</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">6.1 License to use the XHS™ Service and Materials</h3>
            <p>
              Subject to timely payment of all applicable fees and compliance with the Contract, Pimlico grants to Customer, for the Subscription Term, a non-exclusive, non-transferable, non-sublicensable, limited license to:
            </p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
            ...
            <p className="mt-3">
              Unless expressly stated in the Order Form, Customer's license is limited to internal business use and does not permit resale, onward provision as a service, or redistribution of Materials to third parties.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">6.2 Permitted internal use of Materials</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">6.3 Restrictions</h3>
            <p className="mb-3">
          ...
          {/* Section 7 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">7. Customer obligations and Customer Data</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">7.1 Customer obligations</h3>
            <p>Customer shall:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">7.2 Ownership of Customer Data</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">7.3 License to Customer Data</h3>
            <p>Customer grants Pimlico a non-exclusive, worldwide, royalty-free license to host, copy, process, transmit and otherwise use Customer Data:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">7.4 Aggregated and anonymised data</h3>
            <p>
              Pimlico may collect and use (during and after the Subscription Term) aggregated and anonymised data derived from Customer's use of the Services, provided that such data does not identify Customer or any individual. Pimlico may use such data to operate, analyze, improve and develop the XHS™ Service and its business, and may publish high-level statistical information that does not identify Customer.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">7.5 Responsibility for Customer Data</h3>
            <p>
          ...
          {/* Section 8 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">8. Fees, billing and payment</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.1 Fees</h3>
            ...
            <ul className="list-disc ml-6 mt-3 space-y-2">
              ...
              <li>based on (i) subscription or base fees for access to the XHS™ Atlas and its modules, and (ii) usage-based AI Credit charges, together with any other metrics specified in the Order Form or plan.</li>
            </ul>
            <p className="mt-3">
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.2 Subscription commitment and auto-renewal</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.3 Payment method and timing (card, monthly)</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.4 AI Credit charging model</h3>
            <p>AI Credits are used to measure Customer's usage of AI-powered functionality within the XHS™ Atlas. Unless the Order Form states otherwise:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
              ...
              <li>Pimlico will make reasonable usage and consumption information available to Customer via the XHS™ Atlas or other reporting mechanism so that Customer can monitor its AI Credit consumption; and</li>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.5 Changes during the Subscription Term</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.6 Card failures and alternative payment</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.7 Late payment and interest</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.8 Taxes</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.9 Price changes and renewals</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">8.10 Non-payment and refunds</h3>
            <p>
          ...
          {/* Section 9 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">9. Term, renewal and termination</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.1 Subscription Term and non-renewal</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.2 Termination for convenience (where allowed)</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.3 Termination for breach or insolvency</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.4 Termination by Customer for materially detrimental changes</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.5 Termination or suspension for misuse</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">9.6 Effect of termination</h3>
          ...
          {/* Section 10 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">10. Intellectual property</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.1 Pimlico IPR</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.2 Customer IPR</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.3 Use of Pimlico marks</h3>
            <p>
              Customer shall not use any Pimlico trade marks, logos or branding except as expressly permitted in writing by Pimlico.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.4 Feedback</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.5 IPR indemnity</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">10.6 IPR indemnity exceptions and remedies</h3>
          ...
          {/* Section 11 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">11. Confidentiality</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">11.1 Confidential Information</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">11.2 Obligations</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">11.3 Exceptions</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">11.4 Required disclosure</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">11.5 Equitable relief</h3>
            <p>
          ...
          {/* Section 12 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">12. Data protection, privacy and security</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.1 Roles</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.2 Data Processing Addendum</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.3 Privacy Policy</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.4 Information security</h3>
            <p className="mb-4">
              Pimlico will implement and maintain appropriate technical and organizational measures to protect Customer Data against unauthorised or unlawful processing and against accidental loss, destruction or damage, having regard to the nature of the Services, the information to be protected and the state of technological development.
            </p>
            ...
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-4">
              <li>Pimlico's current technical and organizational measures are further described in the Security Overview or similar documentation made available by Pimlico on request or via the XHS™ website, as updated from time to time; and</li>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.5 Use of Customer Data for AI, logging and analytics</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">12.6 Security incidents and personal data breaches</h3>
            <p className="mb-3">
          ...
          {/* Section 13 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">13. Warranties and disclaimers</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.1 Mutual warranties</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.2 Service warranty</h3>
            <p>
              Pimlico will provide the Services with reasonable skill and care and in material accordance with the Documentation.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.3 Beta or trial features</h3>
            <p>
              From time to time, Pimlico may make preview, beta or trial features or modules of the XHS™ Atlas (including AI-powered functionality measured in AI Credits) available. Such features are provided "as is" without warranty, may be changed, suspended or withdrawn at any time and are not subject to any service level or support commitments. For Beta Customers, the Beta Period and any waiver of AI Credit Usage Fees are as described in clauses 1 and 8.4. All other Terms continue to apply in full during any beta, pilot or early-access use.
            </p>

            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.4 Exclusions</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.5 Customer warranties</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">13.6 AI-specific disclaimers</h3>
          ...
          {/* Section 14 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">14. Indemnities</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">14.1 Customer indemnity</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">14.2 Procedure</h3>
            <p>Pimlico shall:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2">
          ...
          {/* Section 15 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">15. Limitation of liability</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">15.1 Non-excludable liability</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">15.2 Excluded types of loss</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">15.3 Overall cap</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">15.4 Customer responsibility</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">15.5 Service levels</h3>
            <p>
          ...
          {/* Section 16 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">16. Service changes, maintenance and updates</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">16.1 Service changes</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">16.2 Changes to these Terms</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">16.3 Planned maintenance</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">16.4 Emergency maintenance</h3>
            <p>
              Pimlico may carry out emergency maintenance without prior notice where necessary to address urgent security or stability issues, and will use reasonable efforts to minimize disruption.
            </p>
          </section>
          ...
          {/* Section 17 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">17. Force majeure</h2>
            <p>
          ...
          {/* Section 18 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">18. Compliance, notices and general</h2>
            
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.1 Anti-bribery, sanctions and export</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.2 Assignment</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.3 Third-party rights</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.4 Relationship of the parties</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.5 Entire agreement</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.6 Severance</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.7 Waiver</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.8 Notices and contact details</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">18.9 Governing law and jurisdiction</h3>
            <p>
          ...
          {/* Schedule 1 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">Schedule 1 – Service Level Agreement</h2>
            <p className="mb-6">
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">1. Scope and relationship with the Terms</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">2. Definitions (SLA)</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">3. Availability commitment</h3>
            
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.1 Availability target</h4>
            <p className="mb-3">
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.2 Planned Maintenance</h4>
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">3.3 Excluded Events</h4>
            ...
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-6">
              ...
              <li>any beta, pilot, early-access or trial features or environments, including any XHS™ Atlas features designated as beta;</li>
              ...
              <li>any emergency maintenance required to address urgent security, stability or performance issues, provided Pimlico uses reasonable efforts to minimize the duration and impact;</li>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">4. Service credits</h3>
            
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.1 Eligibility and calculation</h4>
            <p className="mb-3">
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.2 Application of service credits</h4>
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">4.3 Requesting service credits</h4>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">5. Support</h3>
            
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.1 Support scope and hours</h4>
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.2 Issue categories</h4>
            <p className="mb-3">Pimlico will categorize support issues it receives, acting reasonably, as follows:</p>
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-6">
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.3 Target response times</h4>
            <p className="mb-3">
            ...
            <h4 className="text-xl font-medium text-[var(--color-text-primary)] mt-6 mb-3">5.4 Support exclusions</h4>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">6. Miscellaneous (SLA)</h3>
            <p className="mb-4">
          ...
          {/* Schedule 2 */}
          <section>
            <h2 className="text-3xl font-medium tracking-tight text-[var(--color-text-primary)] mb-6">Schedule 2 – Data Processing Addendum</h2>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">1. Scope and roles</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">2. Definitions (DPA)</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">3. Customer instructions</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">4. Customer responsibilities</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">5. Confidentiality</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">6. Security</h3>
            
            <p className="mb-3">
              <strong>6.1</strong> Pimlico shall implement and maintain appropriate technical and organizational measures to protect Personal Data against accidental or unlawful destruction, loss, alteration, unauthorised disclosure of, or access to, Personal Data, having regard to:
            </p>
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-4">
            ...
            <p className="mb-6">
              <strong>6.2</strong> Pimlico's current technical and organizational measures are described at a high level in the Security Overview or similar documentation made available by Pimlico on request or via the XHS™ website, as updated from time to time. Updates to such documentation will not materially reduce the overall level of protection for Personal Data during the then-current Subscription Term.
            </p>

            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">7. Sub-processors</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">8. International transfers</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">9. Assistance with data subject rights</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">10. Assistance with compliance and DPIAs</h3>
            ...
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-6">
              <li>Customer's obligations to implement appropriate technical and organizational security measures;</li>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">11. Personal Data Breach notification</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">12. Audits and information</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">13. Return and deletion of Personal Data</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">14. Duration</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">15. Miscellaneous</h3>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">Annex 1 – Processing details</h3>
            
            <p className="mb-3"><strong>Subject-matter of the processing</strong></p>
            <p className="mb-6 ml-6">
              Provision of the XHS™ Service and related Services (including XHS™ Atlas and other AI-enabled features), including hosting, storage, analysis, enrichment and delivery of regulatory and market intelligence content, dashboards and reports.
            </p>
            ...
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-6">
              ...
              <li>enabling Customer and Authorised Users to access, search and analyze content;</li>
            ...
            <h3 className="text-2xl font-medium text-[var(--color-text-primary)] mt-8 mb-4">Annex 2 – Technical and organizational measures (summary)</h3>
            
            <p className="mb-4">
              Pimlico will implement and maintain technical and organizational measures appropriate to the risk, which may include:
            </p>
            <ul className="list-disc ml-6 mt-3 space-y-2 mb-6">
            ...
            <p className="mb-6">
              Further details of Pimlico's technical and organizational measures are described in the Security Overview or similar documentation made available by Pimlico on request or via the XHS™ website, as updated from time to time. Updates to such documentation will not materially reduce the overall level of protection for Personal Data during the then-current Subscription Term.
            </p>
          </section>
