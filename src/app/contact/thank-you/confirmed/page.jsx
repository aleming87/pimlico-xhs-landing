    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <div className="isolate px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-3xl pt-20">
          ...
          {/* Thank You from Team & Social Media */}
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <img src="/Andrew.png" alt="Andrew Leming" className="size-20 rounded-full outline-1 -outline-offset-1 outline-white/10 flex-shrink-0" />
                ...
                {/* Urjit */}
                <div className="flex items-center gap-4">
                  <img src="/Urjit.png" alt="Urjit Singh Bhatia" className="size-20 rounded-full outline-1 -outline-offset-1 outline-white/10 flex-shrink-0" />
                  <div className="flex-1">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex items-center justify-center gap-3 mb-6">
                  ...
                  <img src="/XHS Logo BLUE on DARK.png" alt="XHS" className="h-5" />
                </div>
