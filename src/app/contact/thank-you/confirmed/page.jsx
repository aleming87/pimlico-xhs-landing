          ...
          <div className="bg-white/5 rounded-2xl p-8 border border-white/10 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="text-center">
                <img src="/Andrew.png" alt="Andrew Leming" className="mx-auto size-32 rounded-full mb-4 outline-1 -outline-offset-1 outline-white/10" />
                <h3 className="text-lg font-semibold text-white">Andrew Leming</h3>
                <p className="text-sm text-gray-400 mb-3">CEO + Cofounder</p>
                <a 
              ...
              {/* Urjit */}
              <div className="text-center">
                <img src="/Urjit.png" alt="Urjit Singh Bhatia" className="mx-auto size-32 rounded-full mb-4 outline-1 -outline-offset-1 outline-white/10" />
                <h3 className="text-lg font-semibold text-white">Urjit Singh Bhatia</h3>
                <p className="text-sm text-gray-400 mb-3">CTO + Cofounder</p>
                <a 
          ...
          <div className="bg-white/5 rounded-2xl p-8 border border-white/10 mb-8">
            ...
            <div className="flex justify-center items-center gap-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center gap-2 text-gray-400 hover:text-green-400 transition-colors group"
              >
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
