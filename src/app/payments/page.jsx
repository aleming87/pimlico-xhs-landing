    ...
    <div className="bg-white">
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="/payments" className="text-sm/6 font-medium text-blue-600">Payments</a>
            <a href="/gambling" className="text-sm/6 font-medium text-gray-900">Gambling</a>
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="/contact" className="inline-flex items-center rounded-md px-5 py-2.5 font-medium text-sm bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 transition-all duration-200 hover:scale-105">
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    <a href="/" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">Home</a>
                    <a href="/#differentiators" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">How it works</a>
                    <a href="/ai" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">AI</a>
                    <a href="/payments" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-blue-600 hover:bg-gray-50">Payments</a>
                    <a href="/gambling" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">Gambling</a>
                    <a href="/pricing" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">Pricing</a>
                  </div>
                  <div className="py-6">
                    <a href="/contact" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">Book a demo</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6">
                <a href="/contact" className="rounded-lg bg-blue-600 px-8 py-3.5 text-base font-medium text-white shadow-lg hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 text-center transition-all hover:shadow-xl">Explore</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-10 border border-gray-700 shadow-2xl">
              <div className="flex items-center mb-10">
                ...
                <h3 className="text-3xl font-medium text-white">Payment Regulation Trends</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {categories.map((category) => (
                  <div key={category.id} id={`category-${category.id}`} className="bg-gradient-to-r from-gray-700 to-gray-750 rounded-2xl border border-gray-600 overflow-hidden transition-all duration-200 scroll-mt-24">
                    ...
                    >
                      <span className="text-white font-medium text-base text-left">{category.name}</span>
                      <svg 
              ...
              <div key={jurisdiction.id} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200 overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="font-medium text-gray-900 text-lg">{jurisdiction.name}</h3>
                  </div>
                  <svg 
                ...
                {expandedJurisdiction === jurisdiction.id && (
                  <div className="px-6 pb-6 pt-0">
                    <div className="border-t border-gray-200 pt-4">
                      <p className="text-sm font-medium text-gray-700 mb-3">Key Legislation:</p>
      ...
      <div className="bg-gray-900 py-24 sm:py-32">
        <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
          <h2 className="text-center text-base/7 font-medium text-indigo-400">Everything you need</h2>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Licensing Management</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">AML/CTF Compliance</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Payment Security</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Consumer Protection</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Cross-Border Regulations</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Crypto Asset Compliance</h3>
              <p className="text-gray-600">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="/contact?trial=true" className="rounded-lg bg-blue-600 px-8 py-3.5 text-base font-medium text-white shadow-lg hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                Start free trial
              </a>
