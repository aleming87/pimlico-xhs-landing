      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <a href="/ai" className="text-sm/6 font-medium text-blue-600">AI</a>
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    ...
                    <a href="/ai" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-blue-600 hover:bg-gray-50">AI</a>
                    <a href="/payments" className="-mx-3 block rounded-lg px-3 py-2 text-base font-medium leading-7 text-gray-900 hover:bg-gray-50">Payments</a>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-10 border border-gray-700 shadow-2xl">
              <div className="flex items-center mb-10">
                ...
                <h3 className="text-3xl font-medium text-white">AI Regulation Trends</h3>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">AI Risk Assessment</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Model Documentation</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Algorithmic Transparency</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Data Governance</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Safety & Testing</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Bias Monitoring</h3>
              <p className="text-gray-600">
