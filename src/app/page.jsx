      ...
      <div className="bg-white py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          ...
          <ul role="list" className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8">
            ...
            <li className="rounded-2xl bg-gray-100 px-8 py-10">
              <img src="/headshot_main.jpg" alt="Urjit Singh Bhatia" className="mx-auto size-48 rounded-full outline-1 -outline-offset-1 outline-black/5 md:size-56 object-cover" />
        ...
        <footer className="bg-white">
          <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-1 xl:mt-0">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm/6 text-gray-600 hover:text-gray-900">About</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm/6 text-gray-600 hover:text-gray-900">Contact</a>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm/6 text-gray-600 hover:text-gray-900">Privacy</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm/6 text-gray-600 hover:text-gray-900">Terms</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
              <p className="text-sm/6 text-gray-600">&copy; 2025 Pimlico XHS, Inc. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
