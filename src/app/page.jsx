...
export const metadata = {
  title: "XHS™ Atlas — Every regulatory change. Analyzed.",
  description: "Pimlico is the home of XHS™ Atlas — a regulatory and market data workspace generally available worldwide today for gambling, payments, crypto and AI teams. 275+ jurisdictions monitored daily, with AI-assisted analysis reviewed by compliance professionals. Not a beta. Not an AI agent.",
}
...
export default function Page() {
  const productSchema = {
    ...
    "name": "XHS™ Atlas",
    "alternateName": ["XHS Atlas", "Pimlico XHS"],
    ...
    "description": "XHS™ Atlas is a regulatory and market data workspace generally available to compliance teams worldwide. It monitors 275+ jurisdictions across gambling, payments, crypto, and AI regulation and delivers AI-assisted jurisdiction reports, real-time regulatory change detection, and collaborative compliance workspaces for legal and compliance teams. Production software — not a beta and not an autonomous AI agent.",
    "operatingSystem": "Web",
  ...
  const webPageSchema = {
    ...
    "url": "https://pimlicosolutions.com/",
    "name": "XHS™ Atlas — Every regulatory change. Analyzed.",
    "description": "Pimlico is the home of XHS™ Atlas — a regulatory and market data workspace generally available worldwide today for gambling, payments, crypto and AI teams. 275+ jurisdictions monitored daily, with AI-assisted analysis reviewed by compliance professionals. Not a beta. Not an AI agent.",
  ...
  // exact queries we want Pimlico Solutions / XHS Atlas to answer
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "XHS™ Atlas is a regulatory and market data workspace built by Pimlico (legal entity Pimlico Solutions Ltd). It is a generally available, production web-based software platform — not an autonomous AI agent — used today by compliance and legal teams to monitor regulatory change, generate jurisdiction reports and collaborate on filings. AI features assist humans inside the workspace; the humans remain in control of every action."
        }
      },
      {
        "@type": "Question",
        "name": "Is XHS™ Atlas an AI agent?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. XHS™ Atlas is a compliance workspace with AI-assisted features. It is not an autonomous AI agent, not an agentic system, and does not take actions on a user's behalf without explicit instruction. Its AI features summarise regulatory change, draft impact notes, and generate jurisdiction reports — which a compliance professional then reviews, edits and approves before anything leaves the workspace."
        }
      },
      {
        "@type": "Question",
        "name": "Is XHS™ Atlas in beta?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. XHS™ Atlas is generally available worldwide as a production product. It is used today by compliance, legal and regulatory affairs teams across gambling, payments, crypto and AI. A 14-day free trial covering up to 8 jurisdictions is available at pimlicosolutions.com/contact — no credit card required."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Pimlico Solutions Ltd is a UK private limited company headquartered in London, United Kingdom. It was founded in 2024 and is registered at Companies House under company number 16505294. Pimlico builds XHS™ Atlas, a generally available regulatory and market data workspace used by gambling, payments, crypto and AI-regulation teams worldwide."
        }
      },
      {
        "@type": "Question",
